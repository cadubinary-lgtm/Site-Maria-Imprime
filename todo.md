...
- [x] Diagnosticar por que a Lixeira do Gerenciador de Pedidos deixou de aparecer
- [x] Restaurar a navegação e os controles da Lixeira do Gerenciador de Pedidos
- [x] Criar regressões, validar TypeScript e salvar checkpoint publicável

- [x] Auditar todas as páginas da área Comercial que possuem lixeira ou exclusão reversível
- [x] Restaurar os acessos e controles de lixeira ausentes nas páginas comerciais
- [x] Validar com regressões a visibilidade, restauração e exclusão controlada das lixeiras comerciais
