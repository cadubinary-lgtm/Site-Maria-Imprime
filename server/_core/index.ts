...
async function startServer() {
  ...
  // O proxy gerenciado informa o protocolo original em X-Forwarded-Proto.
  // Confiar apenas no primeiro proxy permite redirecionar HTTP sem afetar o ambiente local.
