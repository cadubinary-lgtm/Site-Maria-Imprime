  ...
  cart: router({
    ...
    addItem: publicProcedure
      .input(z.object({
        ...
        urgencyRate: z.number().nonnegative().optional(),
        urgencyMultiplier: z.number().nonnegative().optional(),
        urgencyUnit: z.string().optional(),
        urgencySurcharge: z.number().nonnegative().optional(),
