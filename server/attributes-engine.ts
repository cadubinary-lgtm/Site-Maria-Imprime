/**
 * ========================================
 * ENGINE DE REGRAS DINÂMICAS
 * ========================================
 * Processa regras dinâmicas para mostrar/ocultar/modificar atributos
 */
...
/**
 * Calcular tempo total com modificadores de regras
 */
export function calculateTimeWithRules(
  baseTime: number,
  attributeTimeModifiers: Map<number, number>,
  ruleModifiers: Map<number, number>
): number {
  let total = baseTime;

  // Aplicar modificadores de atributos
  attributeTimeModifiers.forEach((modifier) => {
    total += modifier;
  });
...
/**
 * Calcular peso total com modificadores de regras
 */
export function calculateWeightWithRules(
  baseWeight: number,
  attributeWeightModifiers: Map<number, number>,
  ruleModifiers: Map<number, number>
): number {
  let total = baseWeight;

  // Aplicar modificadores de atributos
  attributeWeightModifiers.forEach((modifier) => {
    total += modifier;
  });
