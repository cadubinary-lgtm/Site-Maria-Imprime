  ...
  return (
    ...
    <Card className="overflow-hidden border border-gray-200 bg-white p-0 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg">
      ...
      <CardContent className="product-card-content relative -mt-3 px-4 pb-4 pt-0">
        ...
        <span className="product-card-action mt-2 inline-flex h-7 w-full items-center justify-center rounded-full bg-pink-600 px-2 text-[11px] font-semibold text-white shadow-sm transition-all hover:bg-pink-700 hover:shadow-md">
          Ver opções
        </span>
      </CardContent>
    </Card>
