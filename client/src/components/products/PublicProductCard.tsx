  ...
  return (
    ...
    <Card className="overflow-hidden border border-gray-200 bg-white p-0 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg">
      ...
      <CardContent className="product-card-content relative -mt-3 px-4 pb-4 pt-0">
        ...
        <span className="product-card-action mx-auto mt-2 inline-flex h-4 w-1/2 items-center justify-center rounded-full bg-pink-600 px-1 text-[9px] font-semibold text-white shadow-sm transition-all hover:bg-pink-700 hover:shadow-md">
          Ver opções
        </span>
      </CardContent>
    </Card>
