      ...
      <CardContent className="product-card-content relative -mt-3 px-4 pb-4 pt-0">
        ...
        <div className={`mt-1.5 grid gap-2 ${isReseller ? "grid-cols-1" : "grid-cols-2"}`}>
          <div className="min-w-0">
            ...
            <p className="product-card-pix-price mt-0.5 whitespace-nowrap text-[clamp(0.875rem,1.6vw,1.125rem)] font-extrabold leading-none text-emerald-600">{formatCurrency(paymentPrices.pix.value)}</p>
