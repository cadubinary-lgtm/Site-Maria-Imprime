...
export function MariaGuide({ content, compact = false }: { content?: MariaGuideContent; compact?: boolean }) {
  ...
  const compactGuideClass = compact
    ? "mt-3 rounded-xl border border-pink-100 bg-white p-2 shadow-[0_10px_28px_rgba(236,17,116,0.05)] sm:p-3 [&_.mg-top-card]:min-h-[64px] [&_.mg-top-card]:overflow-hidden [&_.mg-top-card]:p-2 [&_.mg-top-content]:gap-2 [&_.mg-top-icon]:p-1.5 [&_.mg-top-icon_svg]:h-4 [&_.mg-top-icon_svg]:w-4 [&_.mg-top-title]:text-xs [&_.mg-top-subtitle]:mt-0 [&_.mg-top-subtitle]:line-clamp-2 [&_.mg-top-subtitle]:text-[10px] [&_.mg-top-subtitle]:leading-3 [&_.mg-panel]:min-h-[330px] [&_.mg-panel-header]:gap-2 [&_.mg-panel-header]:px-3 [&_.mg-panel-header]:py-3 [&_.mg-panel-header_svg]:h-5 [&_.mg-panel-header_svg]:w-5"
  ...
  return <section className={compactGuideClass} aria-labelledby="maria-guide-title">
    ...
    <div className={`mt-3 grid gap-2 ${responsivePanelGridClass} ${!expandedPanels.has("impressao") ? "[&>#maria-guide-impressao]:hidden" : ""} ${!expandedPanels.has("material") ? "[&>#maria-guide-material]:hidden" : ""} ${!expandedPanels.has("acabamento") ? "[&>#maria-guide-acabamento]:hidden" : ""} ${!expandedPanels.has("entrega") ? "[&>#maria-guide-entrega]:hidden" : ""}`}>
