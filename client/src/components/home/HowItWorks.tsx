  ...
  return (
    <section className="bg-white py-20 px-4">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold mb-2 text-center text-gray-900">Como funciona</h2>
        <div className="flex justify-center mb-12">
          <div className="w-16 h-1 bg-pink-600 rounded-full" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {STEPS.map((step) => (
            <div key={step.number} className="relative">
              {/* Mascote placeholder */}
              <div className="bg-gradient-to-br from-pink-100 to-pink-50 rounded-2xl p-8 mb-4 flex items-center justify-center min-h-48 border-2 border-pink-200">
                <div className="text-center">
                  <div className="text-5xl mb-2">👩</div>
                  <p className="text-gray-600 text-sm">Mascote {step.number}</p>
                </div>
              </div>

              {/* Step number circle */}
              <div className="absolute -top-4 -left-4 bg-pink-600 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold text-lg shadow-lg">
                {step.number}
              </div>
