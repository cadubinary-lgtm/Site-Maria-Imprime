    ...
    <footer className="bg-gray-900 text-gray-300 py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Institucional */}
          <div>
            <h3 className="font-bold text-white mb-4 text-sm">Institucional</h3>
            <ul className="space-y-2 text-xs">
              <li><a href="#" className="hover:text-pink-600 transition-colors">Sobre a Maria Imprime</a></li>
          ...
          {/* Atendimento */}
          <div>
            <h3 className="font-bold text-white mb-4 text-sm">Atendimento</h3>
            <ul className="space-y-2 text-xs">
              <li>
                <a href="tel:22999459596" className="hover:text-pink-600 transition-colors">
                  📞 22 99945-9596
                </a>
              </li>
              <li>
                <a href="mailto:contatomariaimprime@gmail.com" className="hover:text-pink-600 transition-colors">
                  ✉️ contatomariaimprime@gmail.com
                </a>
              </li>
              <li className="text-xs">
                <p className="font-semibold text-white mt-2 mb-1">Horário de Atendimento:</p>
                <p>Seg-Sex: 09:00 - 12:00 e 13:30 - 17:00</p>
                <p>Sábado e Domingo: Fechada</p>
              </li>
            </ul>
          </div>
          ...
          {/* Formas de Pagamento */}
          <div>
            <h3 className="font-bold text-white mb-4 text-sm">Formas de Pagamento</h3>
          ...
          {/* Siga a Maria */}
          <div>
            <h3 className="font-bold text-white mb-4 text-sm">Siga a Maria</h3>
            <div className="flex gap-4">
              ...
              <a href="https://wa.me/22999459596" target="_blank" rel="noopener noreferrer" className="hover:text-pink-600 transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 text-xs">
          <div>
            <p className="font-semibold text-white mb-2">Carlos Eduardo Barreto Novaes Pinheiro - ME</p>
            <p>CNPJ: 34.528.399/0001-08</p>
            <p>Avenida Antonio Ferreira dos Santos, 651</p>
            <p>Braga - Cabo Frio - Rio de Janeiro</p>
            <p>CEP: 28908-200</p>
          </div>
        </div>
        ...
        <div className="text-center text-xs text-gray-500 border-t border-gray-700 pt-8">
          <p>© 2026 Maria Imprime. Todos os direitos reservados.</p>
