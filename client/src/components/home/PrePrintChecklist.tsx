          ...
          <div className="flex justify-center lg:justify-start">
            <div className="bg-gradient-to-br from-pink-100 to-pink-50 rounded-2xl p-8 flex items-center justify-center min-h-72 border-2 border-pink-200 w-full max-w-sm">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Mascote Checklist</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4 mb-8">
              {CHECKLIST_ITEMS.map((item, idx) => (
                <div key={idx} className="flex items-center gap-4">
                  <div className="w-6 h-6 rounded-full border-2 border-pink-600 flex items-center justify-center flex-shrink-0">
