...
// ─── Ícones SVG inline para Controle de Produção ──────────────────────────────
const IconX = () => (
...
const PRODUCTION_STEPS = [
  ...
  { icon: <IconCircleCheck />, label: "Analisando" },
  { icon: <IconSearch />, label: "Com\nProblemas" },
  { icon: <IconAlertTriangle />, label: "Em Produção" },
  { icon: <IconPrinterSVG />, label: "Pronto p/\nEntrega" },
