            ...
            <Link key={product.id} href={`/catalogo?segment=${product.segment}`}>
              <Card className="cursor-pointer hover:shadow-lg transition-shadow h-full">
                <CardContent className="pt-6">
                  ...
                  <p className="text-lg font-bold text-primary">R$ {parseFloat(product.price).toFixed(2)}</p>
                </CardContent>
              </Card>
            </Link>
          ))}
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                Precisou imprimir? Pedi pra Maria!
              </h1>
              <p className="text-lg text-gray-300 mb-8">
                Soluções gráficas personalizadas para impulsionar sua marca. Rápida, atenciosa e confiável.
              </p>
            ...
            <div className="hidden lg:block">
              <div className="bg-gradient-to-br from-primary/80 to-primary rounded-lg p-8 shadow-2xl">
                <div className="bg-white rounded-lg p-6 text-center">
                  <img src="/manus-storage/LOGOMARIAIMPRIME_84decf52.webp" alt="Maria Imprime" className="h-24 mx-auto mb-4" />
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold mb-12 text-center">Por que escolher Maria?</h2>
      ...
      <section className="bg-gray-50 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-center">Segmentos</h2>
          <p className="text-center text-gray-600 mb-12">Encontre a solução perfeita para seu negócio</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {STEPS.map((step) => (
              <div key={step.number} className="text-center">
                <div className="bg-primary text-white rounded-full w-16 h-16 flex items-center justify-center text-3xl font-bold mx-auto mb-6">
                  {step.number}
                </div>
      ...
      <section className="bg-gray-50 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold mb-12 text-center">Avaliações de Clientes</h2>
      ...
      <section className="bg-gradient-to-r from-slate-900 to-slate-800 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">Pronto para imprimir?</h2>
          <p className="text-lg text-gray-300 mb-8">Explore nosso catálogo e encontre exatamente o que você precisa</p>
