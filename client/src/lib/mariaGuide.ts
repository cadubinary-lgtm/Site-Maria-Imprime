  ...
  sections: [
    ...
    },
    {
      ...
      categories: [guideCategory("acabamentos", "Acabamentos disponíveis", "Opções técnicas e visuais para finalizar o seu material.", [
        guideItem("refile", "Refile", "Corte reto para ajustar o material ao tamanho final."),
        guideItem("corte-especial", "Corte Especial", "Corte realizado em formatos personalizados."),
        guideItem("meio-corte", "Meio Corte", "Corte parcial que permite destacar o adesivo mantendo o liner.", [], "meio-corte"),
        guideItem("laminacao-brilho", "Laminação Brilho", "Proteção com acabamento brilhante e maior destaque para as cores.", [], "laminacao"),
        guideItem("laminacao-fosca", "Laminação Fosca", "Proteção com aparência sofisticada e menor reflexão de luz.", [], "laminacao"),
        guideItem("verniz-localizado", "Verniz Localizado", "Aplicação de verniz em áreas específicas para criar destaque visual."),
        guideItem("uv-localizado", "UV Localizado", "Aplicação localizada com efeito de brilho e destaque visual."),
        guideItem("ilhos", "Ilhós", "Argolas metálicas utilizadas para facilitar a fixação de lonas e banners.", [], "lona-ilhos"),
        guideItem("bastao", "Bastão", "Acabamento para facilitar a instalação e sustentação de banners e faixas.", [], "lona-bastao"),
        guideItem("ponteira", "Ponteira", "Peça utilizada nas extremidades do bastão.", [], "lona-bastao"),
        guideItem("solda", "Solda", "União térmica nas bordas de determinados materiais."),
        guideItem("dobra", "Dobra", "Acabamento que cria uma área dobrada no material.", [], "vinco-dobra"),
        guideItem("vinco", "Vinco", "Marcação que facilita a dobra de papéis e materiais gráficos.", [], "vinco-dobra"),
        guideItem("furo", "Furo", "Perfuração para permitir fixação ou montagem."),
        guideItem("enobrecimentos", "Enobrecimentos", "Acabamentos especiais que agregam valor visual e tátil."),
        guideItem("aplicacao", "Aplicação", "Fixação do material sobre uma superfície quando este serviço estiver disponível."),
        guideItem("embalagem", "Embalagem", "Proteção adequada do produto para transporte e entrega."),
        guideItem("numeracao", "Numeração", "Aplicação de numeração sequencial quando o projeto exigir."),
      ])],
    },
    {
      id: "entrega",
