...
export const companySettings = mysqlTable("companySettings", {
  ...
  instagramUrl: varchar("instagramUrl", { length: 2000 }),
  instagramActive: boolean("instagramActive").default(false).notNull(),
  facebookUrl: varchar("facebookUrl", { length: 2000 }),
  facebookActive: boolean("facebookActive").default(false).notNull(),
  youtubeUrl: varchar("youtubeUrl", { length: 2000 }),
  youtubeActive: boolean("youtubeActive").default(false).notNull(),
  otherSocialUrl: varchar("otherSocialUrl", { length: 2000 }),
  otherSocialActive: boolean("otherSocialActive").default(false).notNull(),
...
export const homeCarouselSlides = mysqlTable("homeCarouselSlides", {
  ...
  imageScale: decimal("imageScale", { precision: 4, scale: 2 }).notNull().default("1.00"),
  imagePositionX: int("imagePositionX").notNull().default(50),
  imagePositionY: int("imagePositionY").notNull().default(50),
...
export const standaloneReceipts = mysqlTable("standaloneReceipts", {
  ...
  cancelledByAdminId: int("cancelledByAdminId"),
  cancelledByAdminName: varchar("cancelledByAdminName", { length: 150 }),
  cancelReason: longtext("cancelReason"),
  whatsappPreparedAt: bigint("whatsappPreparedAt", { mode: "number" }),
  issuedAt: bigint("issuedAt", { mode: "number" }).notNull(),
  issuedByAdminId: int("issuedByAdminId"),
  issuedByAdminName: varchar("issuedByAdminName", { length: 150 }),
